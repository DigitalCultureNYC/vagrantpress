...
3. Open your browser to http://vagrantpress.local

## Working with the environment

To log in to the local Wordpress installation:

`http://vagrantpress.local/wp-admin/` the username is `admin`, the password is `vagrant`.

You can access phpMyAdmin:

`http://vagrantpress.local/phpmyadmin/` with username `wordpress`, password `wordpress`.
